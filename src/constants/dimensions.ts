...
/** Web private sidebar auto-collapses below this width (still ≥ desktop). */
...
/** Private mobile tab bar content height (icon + label + active pill), excluding home indicator. */
export const TAB_BAR_HEIGHT = 70

/** `paddingBottom` for private tab bar: safe-area when present, else theme `x4` (16). */
